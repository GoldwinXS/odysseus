...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "view_image": "See/look at an image with vision — inspect, describe, critique, or analyze it. Give a gallery/generated image id (from generate_image) or a workspace image file path. Use to review an image you generated, read a diagram/screenshot file, or examine a picture. Requires a vision-capable model.",
