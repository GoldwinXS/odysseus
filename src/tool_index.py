...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "spawn_agent": "Spawn a sub-agent to autonomously carry out a self-contained task and report back its result. The sub-agent has full tools (files, shell, browser) but cannot spawn more agents. Delegate, subtask, parallel work, 'have an agent do X and tell me what it found'.",
